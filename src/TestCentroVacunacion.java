...
public class TestCentroVacunacion {
	...
	public void testGenerarYConsultarTurnos() {
		Fecha fechaInicial = new Fecha(12, 7, 2023);
		Fecha fechaSiguiente = new Fecha(13, 7, 2023);
		Fecha fechaAnteriorSinTurnos = new Fecha(11, 7, 2023);
		Fecha fechaPosteriorSinTurnos = new Fecha(14, 7, 2023);
	...
	public void testGenerarTurnosYRegistrarVacunacion() {
		...
		Fecha fecha = new Fecha(11,7,2023);
		assertEquals(20, centro.vacunasDisponibles());
		...
		centro.generarTurnos(new Fecha(16,7,2023));
